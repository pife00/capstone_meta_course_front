    ...
    const dishes = [
        {
            ...
            img: geekSalad,
            price: "12.99",
            description: "The famous greek salad of cripty lettuce, peppers, olives and our Chicago style teta cheese."
        },
        {
            title: "Bruchetta",
            price: "5.99",
            img: bruchetta,
            description: "Our Bruschetta is made from grilled bread that has been smeare with garlic and seasoned "
        },
        {
            title: "Lemon Dessert",
            price: "5.00",
            ...
            <CenterPage>
                <div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-48 py-32" >
                        <h1 className="text-center lg:text-start font-extrabold lg:text-4xl md:text-2xl text-xl font-Markazi" >This Weeks Specials!</h1>
                        <div className="
